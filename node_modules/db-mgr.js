...
{
    var query = "";
    query += "SELECT SUM(p.value) as payments, c.value as clearance ";
    query += "FROM payment as p, clearance as c ";
    query += "WHERE c.user_id = "+_user_id+" ";
    query += "AND c.user_id = p.user_id ";
